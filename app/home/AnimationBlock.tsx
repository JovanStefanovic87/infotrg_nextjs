  ...
  return (
    <>
      ...
      <div className='flex items-start justify-center p-4'>
        <div className='relative flex rounded-xl items-center justify-center bg-blueLight w-full max-w-xs sm:max-w-sm md:max-w-xl lg:max-w-3xl h-32 sm:h-40 md:h-56 lg:h-72 pb-4 overflow-hidden animate-colorChange'>
          ...
          <div className='absolute transform origin-center w-4 h-10 sm:w-5 sm:h-12 md:w-7 md:h-20 lg:w-10 lg:h-32 animate-rotateHorizontal'>
            <svg
              ...
              viewBox='0 0 1167.000000 2622.000000'
              preserveAspectRatio='xMidYMid meet'
            >
              <g
                transform='translate(0.000000,2622.000000) scale(0.100000,-0.100000)'
                fill='#000000'
                stroke='none'
              >
                <path
